            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <Link to="#" className="btn btn-primary">
                  Project cannot be viewed due to sensitive data. Please contact
          ...
          <div className="col-md-4">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <Link
                  to="https://github.com/logbasem/Software_Engineering"
          ...
          <div className="col-md-4">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  OLYMPUS was the result of a 24-hour hackathon and 3
                  sophomore-year coders. Its goal is to put a new twist on the
                  classic "beat-em-up" style game in which an 80s-era Olympic
                  God Ares is working to destroy the city.
                </p>
                <Link
                  to="https://github.com/Brianna-P/OLYMPUS"
                  className="btn btn-primary"
                >
                  View Project
                </Link>
